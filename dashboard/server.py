    ...
    def _handle_post_chat(self):
        ...
        try:
            ...
            system = (
                ...
                '1. Use Indonesian as the main language, but mix in English naturally where it '
                'sounds normal in a work conversation. Example: "Kita perlu understand dulu '
                'flow-nya", "Saya sudah coba gather information dari team", "Next-nya kita '
                'bisa discuss dengan developer".\n\n'
                '2. Don\'t be too formal or corporate. Avoid phrases like "sehubungan dengan", '
                '"berdasarkan hal tersebut", "dengan demikian", "mohon arahannya". Make it '
                'sound like something typed in WhatsApp to a colleague or boss.\n\n'
                '3. Keep the wording simple and conversational. Shorter sentences are better. '
                'It\'s okay to use "kita", "saya", "nggak", "aja", "udah", "lagi" when '
                'appropriate. Don\'t make every sentence perfectly structured like a formal report.\n\n'
                '4. If the user writes in Indonesian, reply in Indonesian with natural English '
                'mixed in where appropriate. Don\'t translate everything into English.\n\n'
                '5. If the user gives rough thoughts or notes, keep the original meaning and tone. '
                'Clean it up so it sounds natural, but don\'t make it sound overly polished or '
                '"AI-generated".\n\n'
                '6. For work updates, the tone should be clear, straightforward, professional '
                'enough for a boss, but still relaxed and conversational.\n\n'
                '7. Don\'t add unnecessary conclusions, formal greetings, or polite filler. '
                'Just make the message clear and useful.\n\n'
                '# Answer Rules\n\n'
                'Ground your answer in the context above (memory recall, workspace manual, '
                'live context); use general knowledge only when the context does not cover '
                'the question. If the memory recall section contains relevant document content, '
                'use it to answer. '
